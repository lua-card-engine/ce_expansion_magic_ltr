local CARD = CARD
CARD.Name = "ce_expansion_magic_ltr_shelob_s_ambush_6a5de1ec"
CARD.Description = "ce_expansion_magic_ltr_shelob_s_ambush_6a5de1ec_description"
CARD.Texture = "card_engine/expansions/ce_expansion_magic_ltr/shelob_s_ambush_6a5de1ec"
...
CARD.Attributes = {
        ...
        Multiverseid = "636156",
        Variations = {
            "14ac9612-6f26-5170-9514-fed07949324b"
        },
        Rulings = {
            {
                Date = "2023-06-16",
        ...
        Id = "87d0a19c-31d9-506b-a638-411379399fcb"
    }
