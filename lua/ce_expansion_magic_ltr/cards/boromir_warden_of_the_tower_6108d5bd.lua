local CARD = CARD
CARD.Name = "ce_expansion_magic_ltr_boromir_warden_of_the_tower_6108d5bd"
CARD.Description = "ce_expansion_magic_ltr_boromir_warden_of_the_tower_6108d5bd_description"
