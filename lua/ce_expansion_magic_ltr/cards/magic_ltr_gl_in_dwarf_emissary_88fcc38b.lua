...
CARD.Texture = "card_engine/expansions/ce_expansion_magic_ltr/gl_in_dwarf_emissary_88fcc38b"
...
CARD.Attributes = {
        ...
        ForeignNames = {
            {
                ...
                Text = "Immer wenn du einen historischen Zauberspruch wirkst, erzeuge einen Schatz-Spielstein. Diese Fähigkeit wird nur einmal pro Zug ausgelöst.\n{T}, opfere einen Schatz: Stachle eine Kreatur deiner Wahl an.",
                Type = "Legendäre Kreatur — Zwerg, Berater",
                Flavor = nil,
                ImageUrl = "http://gatherer.wizards.com/Handlers/Image.ashx?multiverseid=619206&type=card",
                Language = "German",
                Identifiers = {
                    ScryfallId = "d5fe5276-aa90-4516-b17a-22db1749081f",
                    MultiverseId = 619206
                },
                Multiverseid = 619206
            },
            {
                ...
                Text = "À chaque fois que vous lancez un sort historique, créez un jeton Trésor. Cette capacité ne se déclenche qu'une seule fois par tour.\n{T}, sacrifiez un trésor : Incitez une créature ciblée.",
                Type = "Créature légendaire : nain et conseiller",
                Flavor = nil,
                ImageUrl = "http://gatherer.wizards.com/Handlers/Image.ashx?multiverseid=619243&type=card",
                Language = "French",
                Identifiers = {
                    ScryfallId = "625e4f4d-b400-4e42-a4b1-f0b98ab1b3a9",
                    MultiverseId = 619243
                },
                Multiverseid = 619243
            },
            {
                Name = "ドワーフの特使、グローイン",
                Text = "あなたが歴史的な呪文を唱えるたび、宝物・トークン１つを生成する。この能力は、毎ターン１回しか誘発しない。\n{T}, 宝物１つを生け贄に捧げる：クリーチャー１体を対象とする。それを使嗾する。",
                Type = "伝説のクリーチャー — ドワーフ・アドバイザー",
                Flavor = nil,
                ImageUrl = "http://gatherer.wizards.com/Handlers/Image.ashx?multiverseid=619280&type=card",
                Language = "Japanese",
                Identifiers = {
                    ScryfallId = "1c37e036-d41e-4f24-8e2d-f76029b35cd6",
                    MultiverseId = 619280
                },
                Multiverseid = 619280
            },
            {
                Name = "矮人特使格罗因",
                Text = "每当你施放史迹咒语时，派出一个珍宝衍生物。此异能每回合只会触发一次。\n{T}，牺牲一个珍宝：煽惑目标生物。",
                Type = "传奇生物 ～矮人／参谋",
                Flavor = nil,
                ImageUrl = "http://gatherer.wizards.com/Handlers/Image.ashx?multiverseid=619317&type=card",
                Language = "Chinese Simplified",
                Identifiers = {
                    ScryfallId = "7a916f6c-9118-411b-90f1-ef79b55b50dd",
                    MultiverseId = 619317
                },
                Multiverseid = 619317
            }
        ...
        OriginalText = "Whenever you cast a historic spell, create a Treasure token. This ability triggers only once each turn.\n{T}, Sacrifice a Treasure: Goad target creature.",
