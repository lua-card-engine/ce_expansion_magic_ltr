local CARD = CARD
CARD.Name = "ce_expansion_magic_ltr_gimli_mournful_avenger_372677a1"
CARD.Description = "ce_expansion_magic_ltr_gimli_mournful_avenger_372677a1_description"
CARD.Texture = "card_engine/expansions/ce_expansion_magic_ltr/gimli_mournful_avenger_372677a1"
...
CARD.Attributes = {
        ...
        Multiverseid = "619473",
        Variations = {
            "891d6f34-c369-51af-bb68-96e42a931e8b",
        ...
        ForeignNames = {
            {
                ...
                Flavor = nil,
                ImageUrl = "http://gatherer.wizards.com/Handlers/Image.ashx?multiverseid=619503&type=card",
                Language = "German",
                Identifiers = {
                    ScryfallId = "12c06da8-d4bc-4208-a49a-18620ff3be01",
                    MultiverseId = 619503
                },
                Multiverseid = 619503
            },
            {
                ...
                Flavor = nil,
                ImageUrl = "http://gatherer.wizards.com/Handlers/Image.ashx?multiverseid=619533&type=card",
                Language = "Spanish",
                Identifiers = {
                    ScryfallId = "86f91656-aade-48fa-8e46-3e01be8ef0a3",
                    MultiverseId = 619533
                },
                Multiverseid = 619533
            },
            {
                ...
                Flavor = nil,
                ImageUrl = "http://gatherer.wizards.com/Handlers/Image.ashx?multiverseid=619563&type=card",
                Language = "French",
                Identifiers = {
                    ScryfallId = "a573ef10-959a-452e-a53e-974f1bf083b2",
                    MultiverseId = 619563
                },
                Multiverseid = 619563
            },
            {
                ...
                Flavor = nil,
                ImageUrl = "http://gatherer.wizards.com/Handlers/Image.ashx?multiverseid=619593&type=card",
                Language = "Italian",
                Identifiers = {
                    ScryfallId = "e085d864-bd74-45cf-9931-23200bc7785c",
                    MultiverseId = 619593
                },
                Multiverseid = 619593
            },
            {
                Name = "死を悼む復讐者、ギムリ",
                Text = "このターンに２体以上のクリーチャーがあなたのコントロール下で死亡しているかぎり、死を悼む復讐者、ギムリは破壊不能を持つ。\nあなたがコントロール���ていてこれでないクリーチャー１体が死亡するたび、死を悼む復讐者、ギムリの上に＋１/＋１カウンター１個を置く。この能力がこのターン内で３回目に解決されたとき、あなたがコントロールしていないクリーチャー最大１体を対象とする。死を悼む復讐者、ギムリはそれと格闘を行う。",
                Type = "伝説のクリーチャー — ドワーフ・戦士",
                Flavor = nil,
                ImageUrl = "http://gatherer.wizards.com/Handlers/Image.ashx?multiverseid=619623&type=card",
                Language = "Japanese",
                Identifiers = {
                    ScryfallId = "79fb65c0-2001-49e5-8e5d-8ab65f8a6922",
                    MultiverseId = 619623
                },
                Multiverseid = 619623
            },
            {
                ...
                Flavor = nil,
                ImageUrl = "http://gatherer.wizards.com/Handlers/Image.ashx?multiverseid=619653&type=card",
                Language = "Portuguese (Brazil)",
                Identifiers = {
                    ScryfallId = "65d9727e-3957-498e-b957-9b103d2b977e",
                    MultiverseId = 619653
                },
                Multiverseid = 619653
            },
            {
                ...
                Type = "传奇生物 ～矮人／战士",
                Flavor = nil,
                ImageUrl = "http://gatherer.wizards.com/Handlers/Image.ashx?multiverseid=619683&type=card",
                Language = "Chinese Simplified",
                Identifiers = {
                    ScryfallId = "990d2918-03c7-4416-9bca-892a4b1c0d41",
                    MultiverseId = 619683
                },
                Multiverseid = 619683
            }
