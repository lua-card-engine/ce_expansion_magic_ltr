local CARD = CARD
CARD.Name = "ce_expansion_magic_ltr_one_ring_to_rule_them_all_e6abfe35"
CARD.Description = "ce_expansion_magic_ltr_one_ring_to_rule_them_all_e6abfe35_description"
CARD.Texture = "card_engine/expansions/ce_expansion_magic_ltr/one_ring_to_rule_them_all_e6abfe35"
...
CARD.Attributes = {
        ...
        Multiverseid = "636150",
        Variations = {
            "3428febd-4e31-56ff-8dfc-8e3dd035d07b"
        },
        Rulings = {
            {
                Date = "2023-06-16",
        ...
        Id = "15a8f0eb-5450-5689-8adb-14b524606f13"
    }
